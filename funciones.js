...
( window.MSReady = window.MSReady || [] ).push( function( $ ) {
    ...
    "use strict";
    var masterslider_7ffa = new MasterSlider();

    // slider controls
    // slider setup
    masterslider_7ffa.setup("MS6088a01407ffa", {
        width           : 1000,
        height          : 595,
        minHeight       : 0,
        space           : 0,
    ...
    window.masterslider_instances.push( masterslider_7ffa );
});
...
var map;
      ...
      var snp_ajax_url = 'http://donbosco-sanluis.edu.pe/portal/wp-admin/admin-ajax.php';
      ...
      snp_f['snppopup-welcome-open']=snp_bld_open283;snp_f['snppopup-welcome-close']=snp_bld_close283;      
